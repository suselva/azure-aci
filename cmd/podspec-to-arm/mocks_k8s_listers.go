...
func NewMockConfigMapLister() *MockConfigMapLister {
	mock := &MockConfigMapLister{ctrl: nil}
...
func NewMockConfigMapNamespaceLister() *MockConfigMapNamespaceLister {
	mock := &MockConfigMapNamespaceLister{ctrl: nil}
...
func NewMockEndpointsLister() *MockEndpointsLister {
	mock := &MockEndpointsLister{ctrl: nil}
...
func NewMockPodNamespaceLister() *MockPodNamespaceLister {
	mock := &MockPodNamespaceLister{ctrl: nil}
...
func NewMockSecretLister() *MockSecretLister {
	mock := &MockSecretLister{ctrl: nil}
